...
exports.CheckConfig = exports.SetBaseConfig = exports.GetConfig = void 0;
var lodash_1 = require("lodash");
var fs_1 = require("fs");
var path_1 = __importDefault(require("path"));
function GetConfig(args) {
    return __awaiter(this, void 0, void 0, function () {
        var filepath, config, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = (_a = JSON).parse;
                    return [4 /*yield*/, fs_1.promises.readFile(path_1["default"].join(process.cwd(), filepath), { encoding: 'utf-8' })];
                case 1:
...
function CheckConfig(config) {
    if (lodash_1.isEmpty(config.username)) {
        throw "Config.Username must not be blank.";
    }
    if (lodash_1.isEmpty(config.clientID)) {
        throw "Config.clientID must not be blank.";
    }
    if (lodash_1.isEmpty(config.clientSecret)) {
        throw "Config.clientSecret must not be blank.";
    }
    if (lodash_1.isEmpty(config.link)) {
