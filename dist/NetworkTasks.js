...
exports.Login = exports.Get = void 0;
 ...
 */
function Get(path, params, clientId, accessToken) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, url, response, jsonResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    searchParams = new url_1.URLSearchParams(params !== null && params !== void 0 ? params : {});
                    url = "https://api.twitch.tv/helix/" + path + "?" + searchParams.toString();
